# InLine-Analyse-Presc-SIMVASTATINE - Guide d'implémentation du médicament v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **InLine-Analyse-Presc-SIMVASTATINE**

## Example MedicationRequest: InLine-Analyse-Presc-SIMVASTATINE
...
**medication**: SIMVASTATINE EVO 20MG CPR
...
Prescription textuelle: SIMVASTATINE 20MG : 1 comprimé par jour​
...
```json
{
  ...
  "id" : "InLine-Analyse-Presc-SIMVASTATINE",
  "meta" : {
  ...
  "medicationCodeableConcept" : {
    "coding" : [{
      ...
      "code" : "3400892678979",
      "display" : "SIMVASTATINE EVO 20MG CPR"
    }]
  },
  "subject" : {
  ...
  "note" : [{
    "text" : "Prescription textuelle: SIMVASTATINE 20MG : 1 comprimé par jour​"
  }],
  "dosageInstruction" : [{
    "timing" : {
      "repeat" : {
