# Analyse-Validation-Intervention-Liee-Trad-PN13-FHIR - Guide d'implémentation du médicament v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Analyse-Validation-Intervention-Liee-Trad-PN13-FHIR**

## Example Task: Analyse-Validation-Intervention-Liee-Trad-PN13-FHIR
...
> **output****type**: intervention pharmaceutique liée**value**: [Task : groupIdentifier = 10723; status = completed; intent = proposal; authoredOn = 2022-04-11 17:30:53+0200](Task-Analyse-Intervention-Liee-Validation-Trad-PN13-FHIR.md)
...
{
  "resourceType" : "Task",
  "id" : "Analyse-Validation-Intervention-Liee-Trad-PN13-FHIR",
  "meta" : {
