...
| Draft as of 2026-05-27 | *Computable Name*:FRMedicationReconciliationMedicationStatement |
...
* Référence ce Profil: [FR Medication Reconciliation Composition](StructureDefinition-fr-medication-reconciliation-composition.md)

Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.fr.medication|current/StructureDefinition/fr-medication-reconciliation-statement)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://hl7.fr/ig/fhir/medication/StructureDefinition/fr-medicationstatement-reconciliation-properties"]
      }],
      "mustSupport" : true
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://hl7.fr/ig/fhir/medication/StructureDefinition/fr-medication-history-medicationstatement"]
      }],
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://hl7.fr/ig/fhir/medication/StructureDefinition/fr-current-medication-medicationstatement"]
      }],
      "mustSupport" : true
    },
    {
