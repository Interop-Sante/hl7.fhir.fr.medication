# Validation pharmaceutique PN13 avec commentaire - Guide d'implémentation du médicament v0.1.0

* [**Table of Contents**](toc.md)
* **Validation pharmaceutique PN13 avec commentaire**

## Validation pharmaceutique PN13 avec commentaire

### Exemple PN13 de validation pharmaceutique avec commentaire

Cette validation PN13 est traduite en FHIR dans l’instance [Analyse-Validation-Commentaire-Trad-PN13-FHIR](Task-Analyse-Validation-Commentaire-Trad-PN13-FHIR.md)
	...
	<M_Compte_rendu_analyse_pharm>
		...
		<Compte_rendu_pharm>
			...
			<Elément_prescr_pharm>
				...
				<Commentaire_pharmacien>Risque de dépassement de la limite journalière par le patient</Commentaire_pharmacien>
				<Composant_prescrit>
