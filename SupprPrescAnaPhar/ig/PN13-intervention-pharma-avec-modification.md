# Intervention pharmaceutique PN13 avec proposition de modification - Guide d'implémentation du médicament v0.1.0

* [**Table of Contents**](toc.md)
* **Intervention pharmaceutique PN13 avec proposition de modification**

## Intervention pharmaceutique PN13 avec proposition de modification

### Exemple PN13 d’intervention pharmaceutique avec proposition de modification

Cette intervention PN13 est traduite en FHIR dans l’instance [Analyse-Intervention-Proposition-Trad-PN13-FHIR](Task-Analyse-Intervention-Proposition-Trad-PN13-FHIR.md)
	...
	<M_Compte_rendu_analyse_pharm>
		...
		<Compte_rendu_pharm>
			...
			<Elément_prescr_pharm>
				...
				<Elément_lié>
					<Id_Elément_lié>31638</Id_Elément_lié>
					<Type_liaison_élément>6</Type_liaison_élément>
				</Elément_lié>
			</Elément_prescr_pharm>
			<Elément_prescr_pharm>
				<Id_élément_prescr>31638</Id_élément_prescr>
				<Type_élément_prescr>0</Type_élément_prescr>
				<Libellé_élément_prescr>PARACETAMOL (Voie orale) :  1000 mg toutes les 12 heures pendant 2 jours,  2000 mg max/j</Libellé_élément_prescr>
				...
				<Dh_début>20220412060000</Dh_début>
				<Dh_fin>20220415000000</Dh_fin>
				<Commentaire_pharmacien>Suggestion pour prendre en compte la faiblesse hépatique du patient</Commentaire_pharmacien>
				<Composant_prescrit>
					<Type_composant_3>3</Type_composant_3>
					<Code_composant_3>1181</Code_composant_3>
					<Libellé_composant>PARACETAMOL</Libellé_composant>
