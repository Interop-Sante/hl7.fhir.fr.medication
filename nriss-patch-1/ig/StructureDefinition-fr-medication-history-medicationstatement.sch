...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MedicationStatement">
      ...
      <sch:assert test="count(f:extension[@url = 'https://hl7.fr/ig/fhir/medication/StructureDefinition/fr-medication-history-sources']) &lt;= 1">extension with URL = 'https://hl7.fr/ig/fhir/medication/StructureDefinition/fr-medication-history-sources': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:MedicationStatement/f:medication[x] 1</sch:title>
