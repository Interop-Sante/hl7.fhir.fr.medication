# value set Interop'Santé - Type d'écart/erreur sur une ligne de traitement d'une FCT - Guide d'implémentation du médicament v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.fr/ig/fhir/medication/ValueSet/fr-medication-reconciliation-type | *Version*:0.1.0 |
| Draft as of 2025-10-24 | *Computable Name*:FRMedicationReconciliationType |
...
* Include tous les codes définis dans [`https://hl7.fr/ig/fhir/medication/CodeSystem/fr-medication-reconciliation-type`](CodeSystem-fr-medication-reconciliation-type.md)version 📦0.1.0
...
```json
{
  ...
  "url" : "https://hl7.fr/ig/fhir/medication/ValueSet/fr-medication-reconciliation-type",
  "version" : "0.1.0",
  ...
  "compose" : {
    "include" : [
      {
        "system" : "https://hl7.fr/ig/fhir/medication/CodeSystem/fr-medication-reconciliation-type"
      }
    ]
  }
}
