...
| :--- | :--- |
| - | **Dose[x]** |
| * | 6 mg(Details: UCUM codemg = 'mg') |


> **dosageInstruction****sequence**: 2**timing**: Once**route**:Voie orale
...
> **dosageInstruction****sequence**: 3**timing**: Once**route**:Voie orale
