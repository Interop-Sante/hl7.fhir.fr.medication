# value set Interop'Santé - Gravité de l'erreur sur une ligne de traitement d'une FCT - Guide d'implémentation du médicament v0.1.0
...
| Draft as of 2025-10-24 | *Computable Name*:FRMedicationReconciliationOutcome |
...
* Include tous les codes définis dans [`https://hl7.fr/ig/fhir/medication/CodeSystem/fr-medication-reconciliation-outcome`](CodeSystem-fr-medication-reconciliation-outcome.md)version 📦0.1.0
...
```json
{
  ...
  "url" : "https://hl7.fr/ig/fhir/medication/ValueSet/fr-medication-reconciliation-outcome",
  "version" : "0.1.0",
  ...
  "compose" : {
    "include" : [
      {
        "system" : "https://hl7.fr/ig/fhir/medication/CodeSystem/fr-medication-reconciliation-outcome"
      }
    ]
  }
}
