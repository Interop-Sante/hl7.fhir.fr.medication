# Analyse-Validation-Commentaire-Trad-PN13-FHIR - Guide d'implémentation du médicament v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Analyse-Validation-Commentaire-Trad-PN13-FHIR**

## Example Task: Analyse-Validation-Commentaire-Trad-PN13-FHIR
...
> **output****type**: commentaire**value**: Risque de dépassement de la limite journalière par le patient
...
{
  "resourceType" : "Task",
  "id" : "Analyse-Validation-Commentaire-Trad-PN13-FHIR",
  "meta" : {
  ...
  },
  {
    ...
    "valueString" : "Risque de dépassement de la limite journalière par le patient"
  }]
}
