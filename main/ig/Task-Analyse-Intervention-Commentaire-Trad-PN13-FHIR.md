# Analyse-Intervention-Commentaire-Trad-PN13-FHIR - Guide d'implémentation du médicament v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Analyse-Intervention-Commentaire-Trad-PN13-FHIR**

## Example Task: Analyse-Intervention-Commentaire-Trad-PN13-FHIR
...
> **output****type**: commentaire**value**: Paracetamol en doublon par rapport à un autre antalgique déjà préscrit au patient
...
{
  "resourceType" : "Task",
  "id" : "Analyse-Intervention-Commentaire-Trad-PN13-FHIR",
  "meta" : {
  ...
  },
  {
    ...
    "valueString" : "Paracetamol en doublon par rapport à un autre antalgique déjà préscrit au patient"
  }]
}
