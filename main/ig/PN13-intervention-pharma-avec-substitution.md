# Intervention pharmaceutique PN13 avec proposition de substitution - Guide d'implémentation du médicament v0.1.0
...
### Exemple PN13 d’intervention pharmaceutique avec proposition de substitution

Cette intervention PN13 est traduite en FHIR dans l’instance [Analyse-Intervention-Substitution-Trad-PN13-FHIR](Task-Analyse-Intervention-Substitution-Trad-PN13-FHIR.md)
	...
	<M_Compte_rendu_analyse_pharm>
		...
		<Compte_rendu_pharm>
			...
			<Elément_prescr_pharm>
				...
				<Elément_lié>
					<Id_Elément_lié>31639</Id_Elément_lié>
					<Type_liaison_élément>7</Type_liaison_élément>
				</Elément_lié>
			</Elément_prescr_pharm>
			<Elément_prescr_pharm>
				<Id_élément_prescr>31639</Id_élément_prescr>
				<Type_élément_prescr>0</Type_élément_prescr>
				<Libellé_élément_prescr>Ibuprofène (Voie orale) :  800 mg toutes les 12 heures pendant 2 jours, 2400 mg max/j</Libellé_élément_prescr>
				<Cré_arr_mod_val>C</Cré_arr_mod_val>
				<Urgent/>
				<Validation_pharm>1</Validation_pharm>
				<Proposition_pharm>3</Proposition_pharm>
				<Voie_administration>54</Voie_administration>
				<Dh_début>20220412060000</Dh_début>
				<Dh_fin>20220415000000</Dh_fin>
				<Commentaire_pharmacien>Remplacement pour éviter interaction entre paracétamol et autre traitement pris par le patient</Commentaire_pharmacien>
				<Composant_prescrit>
					<Type_composant_3>3</Type_composant_3>
					<Code_composant_3>2029</Code_composant_3>
					<Libellé_composant>IBUPROFENE</Libellé_composant>
					<Quantité_composant_prescrite>
						<Nombre>800.0</Nombre>
						<Unité>mg</Unité>
					</Quantité_composant_prescrite>
				...
				<Elément_posologie>
					<Fréquence_structurée>
						...
						<Frq_libellé>une fois toutes les 12 heures</Frq_libellé>
					</Fréquence_structurée>
					<Quantité>
						<Nombre>800.0</Nombre>
						<Unité>mg</Unité>
