...
- 1 à n ressource(s) *MedicationRequest* suivant le profil (FrInpatientMedicationRequest)[StructureDefinition-FrInpatientMedicationRequest.html].  Chaque ressource *MedicationRequest* référence:
