...
Une proposition est représentée par une ressource *MedicationRequest*suivant le profil [FrInpatientPharmaceuticalInterventionSuggestionProfile](StructureDefinition-fr-inpatient-pharmaceutical-intervention-suggestion.html) qui hérite du profil *FRMedicationRequest* avec les attributs suivants:
