...
* traitement.dosage.valeur 0..1 string "Valeur du dosage"
...
// la quantité prescrite doit être au niveau de la fréquence car il peut y avoir plusieurs séquences avec chacune une durée propre
...
* posologie.quantitéMax.valeur 0..1 string "Valeur maximale"
* posologie.quantitéMax.quantité 0..1 code "Unité de la valeur maximale à prendre"
* posologie.quantitéMax.unite 0..1 code "Unité de temps"

* posologie.frequence 0..* base "Fréquence de prise"
* posologie.frequence.valeur 0..1 string "Valeur maximale"
* posologie.frequence.unite 0..1 code "Unité de temps"
* posologie.frequence.jourSemaine 0..1 code "Jour de la semaine de la prise"
* posologie.frequence.heure 0..1 time "Heure de la prise"
...
* posologie.dureeAdministration.dureeMax 0..1 decimal "Durée de l'administration"
