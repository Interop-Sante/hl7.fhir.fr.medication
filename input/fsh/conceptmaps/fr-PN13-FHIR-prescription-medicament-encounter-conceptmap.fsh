...
* group[0].element[0].code = $PN13Schema#M_prescription_médicaments/Séjour/Id_séjour
...
* group[0].element[1].code = $PN13Schema#M_prescription_médicaments/Séjour/DI_séjour
