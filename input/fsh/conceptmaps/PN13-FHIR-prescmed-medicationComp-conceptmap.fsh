...
* targetUri = $FrMedicationCompound
* group[0].element[0].code = $PN13Schema#Messages/M_prescription_médicaments/Prescription/Elément_prescr_médic/Forme
* group[0].element[0].target[0].code = $FrMedicationCompound#Medication.form.coding.code
...
* group[0].element[1].target[0].code = $FrMedicationCompound#Medication.form.coding.code
...
* group[0].element[2].target[0].code = $FrMedicationCompound#Medication.form.coding.code
...
* group[0].element[2].target[0].product[0].property = $FrMedicationCompound#Medication.form.coding.system
* group[0].element[2].target[0].product[0].value = "http://standardterms.edqm.eu"
* group[0].element[3].target[0].code = $FrMedicationCompound#Medication.form.coding.code
