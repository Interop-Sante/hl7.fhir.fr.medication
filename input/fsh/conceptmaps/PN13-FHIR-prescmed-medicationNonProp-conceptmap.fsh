...
* group[0].element[0].code = $PN13Schema#Messages/M_prescription_médicaments/Prescription/Elément_prescr_médic/Forme
* group[0].element[0].target[1].code = $FrMedicationNonproprietaryName#Medication.form.coding.code
...
* group[0].element[0].target[2].code = $FrMedicationNonproprietaryName#Medication.form.coding.code
...
* group[0].element[0].target[2].product[0].property = $FrMedicationNonproprietaryName#Medication.form.coding.system
* group[0].element[0].target[2].product[0].value = "http://standardterms.edqm.eu"
* group[0].element[0].target[3].code = $FrMedicationNonproprietaryName#Medication.form.coding.code
