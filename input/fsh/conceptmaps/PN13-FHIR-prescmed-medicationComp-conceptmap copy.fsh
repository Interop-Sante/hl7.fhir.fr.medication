...
* group[0].element[0].target[2].code = $FrMedicationCompound#Medication.form.coding.code
...
* group[0].element[0].target[2].product[0].property = $FrMedicationCompound#Medication.form.coding.system
* group[0].element[0].target[2].product[0].value = "http://standardterms.edqm.eu"
* group[0].element[0].target[3].code = $FrMedicationCompound#Medication.form.coding.code
