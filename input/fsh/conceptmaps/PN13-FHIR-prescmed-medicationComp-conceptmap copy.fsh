...
* targetUri = $FrInpatientMedicationCompound
* group[0].element[0].code = $PN13Schema#Messages/M_prescription_médicaments/Prescription/Elément_prescr_médic/Forme
* group[0].element[0].target[0].code = $FrInpatientMedicationCompound#Medication.form.coding.code
...
* group[0].element[0].code = $PN13Schema#Messages/M_prescription_médicaments/Prescription/Elément_prescr_médic/Forme
* group[0].element[0].target[1].code = $FrInpatientMedicationCompound#Medication.form.coding.code
...
* group[0].element[0].target[2].code = $FrInpatientMedicationCompound#Medication.form.coding.code
...
* group[0].element[0].target[2].product[0].property = $FrInpatientMedicationCompound#Medication.form.coding.system
* group[0].element[0].target[2].product[0].value = "http://standardterms.edqm.eu"
* group[0].element[0].target[3].code = $FrInpatientMedicationCompound#Medication.form.coding.code
