...
* group[1].element[0].code = $PN13Schema#Messages/M_prescription_médicaments/Patient/Nom_naissance
...
* group[1].element[1].code = $PN13Schema#Messages/M_prescription_médicaments/Patient/Premier_prénom
* group[1].element[1].target[0].code = $FrCorePatient#Patient.name.given
* group[1].element[1].target[0].equivalence = #equal
* group[1].element[2].code = $PN13Schema#Messages/M_prescription_médicaments/Patient/Prénoms
...
* group[2].element[0].code = $PN13Schema#Messages/M_prescription_médicaments/Patient/Nom_usuel
...
* group[2].element[1].code = $PN13Schema#Messages/M_prescription_médicaments/Patient/Prénom_usuel
* group[2].element[1].target[0].code = $FrCorePatient#Patient.name.given
* group[2].element[1].target[0].equivalence = #equal
* group[3].element[0].code = $PN13Schema#Messages/M_prescription_médicaments/Patient/Date_naissance
...
* group[3].element[1].code = $PN13Schema#Messages/M_prescription_médicaments/Patient/Sexe
...
* group[4].element[0].code = $PN13Schema#Messages/M_prescription_médicaments/Patient/Lieu_naissance
...
* group[5].element[0].code = $PN13Schema#Messages/M_prescription_médicaments/Patient/Statut_idpat
...
* group[6].element[0].code = $PN13Schema#Messages/M_prescription_médicaments/Patient/Date_lunaire
