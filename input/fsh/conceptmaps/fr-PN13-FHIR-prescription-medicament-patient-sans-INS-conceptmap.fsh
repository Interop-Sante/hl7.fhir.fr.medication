...
* url: "https://hl7.fr/ig/fhir/medication/ConceptMap/fr-PN13-FHIR-prescription-medicament-patient-sans-INS-conceptmap"
* version: "0.1"
...
* group[1].element[0].code: "M_prescription_médicaments/Patient/Nom_naissance"
* group[1].element[0].target[0].code: "Patient.name.family"
...
* group[1].element[1].code: "M_prescription_médicaments/Patient/Premier_prénom"
* group[1].element[1].target[0].code: "Patient.name.given"
* group[1].element[1].target[0].equivalence: "equal"
* group[1].element[2].code: "M_prescription_médicaments/Patient/Prénoms"
* group[1].element[2].target[0].code: "Patient.name.extension.valueString"
...
* group[2].element[0].code: "M_prescription_médicaments/Patient/Nom_usuel"
...
* group[2].element[1].code: "M_prescription_médicaments/Patient/Prénom_usuel"
* group[2].element[1].target[0].code: "Patient.name.given"
* group[2].element[1].target[0].equivalence: "equal"
* group[3].element[0].code: "M_prescription_médicaments/Patient/Date_naissance"
* group[3].element[0].target[0].code: "Patient.birthDate"
...
* group[3].element[1].code: "M_prescription_médicaments/Patient/Sexe"
* group[3].element[1].target[0].code: "Patient.gender"
...
* group[4].element[0].code: "M_prescription_médicaments/Patient/Lieu_naissance"
* group[4].element[0].target[0].code: "Patient.extension.valueAddress.extension.valueCoding.code"
...
* group[5].element[0].code: "M_prescription_médicaments/Patient/Statut_idpat"
* group[5].element[0].target[0].code: "Patient.extension.extension.valueCoding.code"
...
* group[6].element[0].code: "M_prescription_médicaments/Patient/Date_lunaire"
