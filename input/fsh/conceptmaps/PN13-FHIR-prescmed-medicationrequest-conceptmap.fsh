...
* group[1].element[3].target[1].code = #MedicationRequest.priority
...
* group[1].element[3].target[1].product[0].property = #MedicationRequest.priority
...
* group[1].element[4].target[0].code = #MedicationRequest.dosageInstruction.route.coding.code
...
* group[1].element[4].target[0].product[0].property = #MedicationRequest.dosageInstruction.route.coding.system
* group[1].element[4].target[0].product[0].value = "http://standardterms.edqm.eu"
* group[1].element[4].target[1].code = #MedicationRequest.dosageInstruction.route.coding.code
...
* group[1].element[4].target[1].product[0].property = #MedicationRequest.dosageInstruction.route.coding.system
* group[1].element[4].target[1].product[0].value = "http://standardterms.edqm.eu"
* group[1].element[4].target[2].code = #MedicationRequest.dosageInstruction.route.coding.code
...
* group[1].element[5].target[0].code = #MedicationRequest.dispenseRequest.performer.display
...
* group[1].element[6].target[0].code = #MedicationRequest.supportingInformation.display
* group[1].element[6].target[0].equivalence = #equal
* group[1].element[6].target[0].product[0].property = #MedicationRequest.supportingInformation.type
