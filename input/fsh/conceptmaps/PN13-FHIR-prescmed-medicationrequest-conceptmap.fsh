...
* group[6].element[1].code = $PN13Schema#Messages/M_prescription_médicaments/Prescription/Elément_prescr_médic/Lieu_administration
* group[6].element[1].target[0].code = #MedicationRequest.dispenseRequest.performer.display
* group[6].element[1].target[0].equivalence = #equal
* group[6].element[2].code = $PN13Schema#Messages/M_prescription_médicaments/Prescription/Elément_prescr_médic/Dispositif_associé
* group[6].element[2].target[0].code = #MedicationRequest.supportingInformation.display
* group[6].element[2].target[0].equivalence = #equal
* group[6].element[2].target[0].product[0].property = #MedicationRequest.supportingInformation.type
* group[6].element[2].target[0].product[0].value = "Device"
// mettre extension pour qualifier la note
* group[6].element[3].code = $PN13Schema#Messages/M_prescription_médicaments/Prescription/Elément_prescr_médic/Posologie
* group[6].element[3].target[0].code = #MedicationRequest.note.text
* group[6].element[3].target[0].equivalence = #equal
...
* group[10].element[7].code = $PN13Schema#Messages/M_prescription_médicaments/Prescription/Elément_prescr_médic/Motif_attente
* group[10].element[7].target[0].code = #MedicationRequest.statusReason.text
* group[10].element[7].target[0].equivalence = #equal
* group[10].element[8].code = $PN13Schema#Messages/M_prescription_médicaments/Prescription/Elément_prescr_médic/Delta_dh_référence
* group[10].element[8].target[0].equivalence = #unmatched
* group[10].element[9].code = $PN13Schema#Messages/M_prescription_médicaments/Prescription/Elément_prescr_médic/Conditions_application
// mettre extension pour qualifier la note
* group[10].element[9].target[0].code = #MedicationRequest.note.text
* group[10].element[9].target[0].equivalence = #equal
