...
* group[0].element[0].target[0].code = #MedicationRequest.identifier.value
...
* group[0].element[1].target[0].code = #MedicationRequest.identifier.system
...
* group[1].element[0].target[0].code = #MedicationRequest.medicationReference.reference
...
* group[1].element[1].target[0].code = #MedicationRequest.text
...
* group[1].element[3].target[0].code = #MedicationRequest.priority
...
* group[1].element[3].target[0].product[0].property = #MedicationRequest.priority
* group[1].element[3].target[0].product[0].value = "urgent"
* group[1].element[4].target[0].code = #MedicationRequest.priority
* group[1].element[4].target[0].equivalence = #equivalent
* group[1].element[4].target[0].dependsOn[0].property = $PN13Schema#Messages/M_prescription_médicaments/Prescription/Elément_prescr_médic/Urgent
* group[1].element[4].target[0].dependsOn[0].value = "false"
* group[1].element[4].target[0].product[0].property = #MedicationRequest.priority
* group[1].element[4].target[0].product[0].value = "routine"
* group[1].element[5].target[0].code = #MedicationRequest.priority
* group[1].element[5].target[0].equivalence = #equivalent
* group[1].element[5].target[0].dependsOn[0].property = $PN13Schema#Messages/M_prescription_médicaments/Prescription/Elément_prescr_médic/Urgent
* group[1].element[5].target[0].dependsOn[0].value = "Null"
* group[1].element[5].target[0].product[0].property = #MedicationRequest.priority
* group[1].element[5].target[0].product[0].value = "routine"
* group[1].element[6].code = $PN13Schema#Messages/M_prescription_médicaments/Prescription/Elément_prescr_médic/Fourniture
* group[1].element[6].target[0].equivalence = #unmatched
* group[1].element[6].code = $PN13Schema#Messages/M_prescription_médicaments/Prescription/Elément_prescr_médic/Voie_administration
* group[1].element[6].target[0].code = #MedicationRequest.dosageInstruction.route.coding.code
* group[1].element[6].target[0].equivalence = #equal
* group[1].element[6].target[0].dependsOn[0].property = $PN13Schema#Messages/M_prescription_médicaments/Prescription/Elément_prescr_médic/Voie_administration@Phast-nomenclature
* group[1].element[6].target[0].dependsOn[0].value = "EDQM"
* group[1].element[6].target[0].product[0].property = #MedicationRequest.dosageInstruction.route.coding.system
* group[1].element[6].target[0].product[0].value = "http://standardterms.edqm.eu"
* group[1].element[6].target[1].code = #MedicationRequest.dosageInstruction.route.coding.code
* group[1].element[6].target[1].equivalence = #equivalent
* group[1].element[6].target[1].comment = "le code cible est à trouver dans le mapping SIPh-CIO_Voie_administration / EDMQ"
* group[1].element[6].target[1].dependsOn[0].property = $PN13Schema#Messages/M_prescription_médicaments/Prescription/Elément_prescr_médic/Voie_administration@Phast-nomenclature
* group[1].element[6].target[1].dependsOn[0].value = "SIPh-CIO_Voie_administration"
* group[1].element[6].target[1].product[0].property = #MedicationRequest.dosageInstruction.route.coding.system
* group[1].element[6].target[1].product[0].value = "http://standardterms.edqm.eu"
* group[1].element[6].target[2].code = #MedicationRequest.dosageInstruction.route.coding.code
* group[1].element[6].target[2].equivalence = #unmatched
* group[1].element[6].target[2].dependsOn[0].property = $PN13Schema#Messages/M_prescription_médicaments/Prescription/Elément_prescr_médic/Voie_administration@Phast-nomenclature
* group[1].element[6].target[2].dependsOn[0].value = "SIPh-Voie_administration"
* group[1].element[7].code = $PN13Schema#Messages/M_prescription_médicaments/Prescription/Elément_prescr_médic/Lieu_administration
* group[1].element[7].target[0].code = #MedicationRequest.dispenseRequest.performer.display
* group[1].element[7].target[0].equivalence = #equal
* group[1].element[8].code = $PN13Schema#Messages/M_prescription_médicaments/Prescription/Elément_prescr_médic/Dispositif_associé
* group[1].element[8].target[0].code = #MedicationRequest.supportingInformation.display
* group[1].element[8].target[0].equivalence = #equal
* group[1].element[8].target[0].product[0].property = #MedicationRequest.supportingInformation.type
* group[1].element[8].target[0].product[0].value = "Device"
* group[2].element[0].code = $PN13Schema#Messages/M_prescription_médicaments/Prescription/Elément_prescr_médic/Commentaire
* group[2].element[0].target[0].code = #MedicationRequest.note.text
...
* group[3].element[1].target[0].code = #MedicationRequest.note.authorReference.identifier.value
...
* group[3].element[2].target[0].code = #MedicationRequest.note.authorReference.identifier.system
...
* group[3].element[3].target[0].code = #MedicationRequest.note.authorReference.display
...
* group[3].element[4].target[0].code = #MedicationRequest.note.authorReference.display
...
* group[3].element[5].target[0].code = #MedicationRequest.note.authorReference.display
...
* group[3].element[6].target[0].code = #MedicationRequest.note.authorReference.display
...
* group[3].element[7].target[0].code = #MedicationRequest.note.authorReference.display
...
* group[3].element[8].target[0].code = #MedicationRequest.note.authorReference.display
...
* group[3].element[9].target[0].code = #MedicationRequest.note.authorReference.display
...
* group[3].element[13].target[0].code = #MedicationRequest.note.text
...
* group[4].element[1].target[0].code = #MedicationRequest.status
...
* group[4].element[1].target[0].product[0].property = #MedicationRequest.status
* group[4].element[1].target[0].product[0].value = "unknown"
* group[4].element[1].target[0].product[1].property = #MedicationRequest.intent
* group[4].element[1].target[0].product[1].value = "order"
* group[4].element[1].target[1].code = #MedicationRequest.status
...
* group[4].element[1].target[1].product[0].property = #MedicationRequest.status
* group[4].element[1].target[1].product[0].value = "on-hold"
* group[4].element[1].target[1].product[1].property = #MedicationRequest.intent
* group[4].element[1].target[1].product[1].value = "order"
* group[4].element[1].target[2].code = #MedicationRequest.status
...
* group[4].element[1].target[2].product[0].property = #MedicationRequest.status
* group[4].element[1].target[2].product[0].value = "active"
* group[4].element[1].target[2].product[1].property = #MedicationRequest.intent
* group[4].element[1].target[2].product[1].value = "order"
* group[4].element[1].target[3].code = #MedicationRequest.status
...
* group[4].element[1].target[3].product[0].property = #MedicationRequest.status
* group[4].element[1].target[3].product[0].value = "active"
* group[4].element[1].target[3].product[1].property = #MedicationRequest.intent
* group[4].element[1].target[3].product[1].value = "order"
* group[4].element[1].target[4].code = #MedicationRequest.status
...
* group[4].element[1].target[4].product[0].property = #MedicationRequest.status
* group[4].element[1].target[4].product[0].value = "cancelled"
* group[4].element[1].target[4].product[1].property = #MedicationRequest.intent
...
* group[4].element[2].target[0].code = #MedicationRequest.statusReason.text
...
* group[4].element[4].target[0].code = #MedicationRequest.note.text
