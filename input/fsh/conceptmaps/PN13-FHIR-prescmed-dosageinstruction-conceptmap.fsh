...
* group[2].element[2].code = $PN13Schema-Posologie#Elément_posologie/Fréquence_structurée/Frq_filtre/Frq_filtreVal_1_J
* group[2].element[2].target[0].code = $FhirDosage#Dosage.timing.repeat.dayOfWeek
* group[2].element[2].target[0].equivalence = #equivalent
* group[2].element[2].target[0].comment = "Si présence d'élémént(s) Frq_filtreVal_1_N, chaque Frq_filtreVal_1_N donne lieu à une occurrence de dosageInstruction reprenant dans les éléments et indiquant dans timing.repeat.boundsPeriod la semaine concernée"
* group[2].element[2].target[0].dependsOn[0].property = $PN13Schema-Posologie#Elément_posologie/Fréquence_structurée/Frq_filtre/Frq_filtreVal_1_J
* group[2].element[2].target[0].dependsOn[0].value = "3"
* group[2].element[2].target[0].product[0].property = $FhirDosage#Dosage.timing.repeat.dayOfWeek
* group[2].element[2].target[0].product[0].value = "wed"
* group[2].element[3].code = $PN13Schema-Posologie#Elément_posologie/Fréquence_structurée/Frq_filtre/Frq_filtreVal_1_J
* group[2].element[3].target[0].code = $FhirDosage#Dosage.timing.repeat.dayOfWeek
* group[2].element[3].target[0].equivalence = #equivalent
* group[2].element[3].target[0].comment = "Si présence d'élémént(s) Frq_filtreVal_1_N, chaque Frq_filtreVal_1_N donne lieu à une occurrence de dosageInstruction reprenant dans les éléments et indiquant dans timing.repeat.boundsPeriod la semaine concernée"
* group[2].element[3].target[0].dependsOn[0].property = $PN13Schema-Posologie#Elément_posologie/Fréquence_structurée/Frq_filtre/Frq_filtreVal_1_J
* group[2].element[3].target[0].dependsOn[0].value = "4"
* group[2].element[3].target[0].product[0].property = $FhirDosage#Dosage.timing.repeat.dayOfWeek
* group[2].element[3].target[0].product[0].value = "thu"
* group[2].element[4].code = $PN13Schema-Posologie#Elément_posologie/Fréquence_structurée/Frq_filtre/Frq_filtreVal_1_J
* group[2].element[4].target[0].code = $FhirDosage#Dosage.timing.repeat.dayOfWeek
* group[2].element[4].target[0].equivalence = #equivalent
* group[2].element[4].target[0].comment = "Si présence d'élémént(s) Frq_filtreVal_1_N, chaque Frq_filtreVal_1_N donne lieu à une occurrence de dosageInstruction reprenant dans les éléments et indiquant dans timing.repeat.boundsPeriod la semaine concernée"
* group[2].element[4].target[0].dependsOn[0].property = $PN13Schema-Posologie#Elément_posologie/Fréquence_structurée/Frq_filtre/Frq_filtreVal_1_J
* group[2].element[4].target[0].dependsOn[0].value = "5"
* group[2].element[4].target[0].product[0].property = $FhirDosage#Dosage.timing.repeat.dayOfWeek
* group[2].element[4].target[0].product[0].value = "fri"
* group[2].element[5].code = $PN13Schema-Posologie#Elément_posologie/Fréquence_structurée/Frq_filtre/Frq_filtreVal_1_J
* group[2].element[5].target[0].code = $FhirDosage#Dosage.timing.repeat.dayOfWeek
* group[2].element[5].target[0].equivalence = #equivalent
* group[2].element[5].target[0].comment = "Si présence d'élémént(s) Frq_filtreVal_1_N, chaque Frq_filtreVal_1_N donne lieu à une occurrence de dosageInstruction reprenant dans les éléments et indiquant dans timing.repeat.boundsPeriod la semaine concernée"
* group[2].element[5].target[0].dependsOn[0].property = $PN13Schema-Posologie#Elément_posologie/Fréquence_structurée/Frq_filtre/Frq_filtreVal_1_J
* group[2].element[5].target[0].dependsOn[0].value = "6"
* group[2].element[5].target[0].product[0].property = $FhirDosage#Dosage.timing.repeat.dayOfWeek
* group[2].element[5].target[0].product[0].value = "sat"
* group[2].element[6].code = $PN13Schema-Posologie#Elément_posologie/Fréquence_structurée/Frq_filtre/Frq_filtreVal_1_J
* group[2].element[6].target[0].code = $FhirDosage#Dosage.timing.repeat.dayOfWeek
* group[2].element[6].target[0].equivalence = #equivalent
* group[2].element[6].target[0].comment = "Si présence d'élémént(s) Frq_filtreVal_1_N, chaque Frq_filtreVal_1_N donne lieu à une occurrence de dosageInstruction reprenant dans les éléments et indiquant dans timing.repeat.boundsPeriod la semaine concernée"
* group[2].element[6].target[0].dependsOn[0].property = $PN13Schema-Posologie#Elément_posologie/Fréquence_structurée/Frq_filtre/Frq_filtreVal_1_J
* group[2].element[6].target[0].dependsOn[0].value = "7"
* group[2].element[6].target[0].product[0].property = $FhirDosage#Dosage.timing.repeat.dayOfWeek
* group[2].element[6].target[0].product[0].value = "sun"
* group[3].element[0].code = $PN13Schema-Posologie#Elément_posologie/Quantité/Nombre
* group[3].element[0].target[0].code = $FhirDosage#Dosage.doseAndRate.doseQuantity.value
* group[3].element[0].target[0].equivalence = #equal
* group[3].element[1].code = $PN13Schema-Posologie#Elément_posologie/Quantité/Unité
* group[3].element[1].target[0].code = $FhirDosage#Dosage.doseAndRate.doseQuantity.code
* group[3].element[1].target[0].equivalence = #equal
* group[3].element[1].target[0].dependsOn[0].property = $PN13Schema-Posologie#Elément_posologie/Quantité/Unité@Phast-nomenclature
