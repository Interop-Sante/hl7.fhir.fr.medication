...
Id: FrMedicationReconciliationType
...
* ^url = "http://interopsante.org/fhir/ValueSet/fr-medication-reconciliation-type"
* ^version = "0.2.0"
* ^status = #draft
* ^experimental = false
...
* ^immutable = false
* include codes from system http://interopsante.org/fhir/CodeSystem/fr-medication-reconciliation-type|0.2.0