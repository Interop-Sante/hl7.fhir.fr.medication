...
* dosageInstruction[=].timing.repeat.boundsDuration = 2 $unitsofmeasure#d "jour"
* dosageInstruction[=].timing.repeat.timeOfDay = "07:00:00"
* dosageInstruction[=].route = $EDQM#20053000 "Voie orale"
* dosageInstruction[=].route.text = "Voie orale"
* dosageInstruction[=].doseAndRate.doseQuantity = 6 $unitsofmeasure#mg "mg"
* dosageInstruction[+].sequence = 2
* dosageInstruction[=].timing.repeat.boundsDuration = 2 $unitsofmeasure#d "jour"
* dosageInstruction[=].timing.repeat.timeOfDay = "07:00:00"
* dosageInstruction[=].route = $EDQM#20053000 "Voie orale"
* dosageInstruction[=].route.text = "Voie orale"
* dosageInstruction[=].doseAndRate.doseQuantity = 4 $unitsofmeasure#mg "mg"
* dosageInstruction[+].sequence = 3
* dosageInstruction[=].timing.repeat.boundsDuration = 2 $unitsofmeasure#d "jour"
* dosageInstruction[=].timing.repeat.timeOfDay = "07:00:00"
* dosageInstruction[=].route = $EDQM#20053000 "Voie orale"
* dosageInstruction[=].route.text = "Voie orale"
* dosageInstruction[=].doseAndRate.doseQuantity = 2 $unitsofmeasure#mg "mg"