Instance: bundle-20001
InstanceOf: fr-prescription-bundle-for-example
// exemple de traduction de UCD-2Bis.pn13 
Usage: #example
* type = #searchset
* entry[0].resource.resourceType = "Patient"
* entry[=].resource.id = "Patient-20001"
...
* entry[=].resource.medicationReference.reference = "#med-20001"
* entry[=].resource.subject.reference = "#Patient-20001"
...
* entry[=].resource.requester.reference = "#Practitioner-20001"
