...
* type = #searchset
* entry.resource = medicationrequest-HAS-30-1-Presc-Hydrocortisone
...
* dosageInstruction[0].timing.repeat.boundsDuration = 6 $unitsofmeasure#mo "mois"
...
* dosageInstruction[=].timing.repeat.boundsDuration = 6 $unitsofmeasure#mo "mois"
* dosageInstruction[=].timing.repeat.when[0] = #MORN
* dosageInstruction[=].timing.repeat.when[+] = #NOON
* dosageInstruction[=].doseAndRate.doseQuantity = 2 $EDQM#15054000 "Comprimé"
* dosageInstruction[=].maxDosePerPeriod.numerator = 6 $EDQM#15054000 "Comprimé"
* dosageInstruction[=].maxDosePerPeriod.denominator = 1 $unitsofmeasure#d "jour"
* dosageInstruction[+].additionalInstruction.text = "En cas de fièvre > 40°C"
* dosageInstruction[=].timing.repeat.boundsDuration = 6 $unitsofmeasure#mo "mois"
