Instance: Analyse-Intervention-Commentaire-Trad-PN13-FHIR
...
* output[=].valueString = "Paracetamol en doublon par rapport à un autre antalgique déjà préscrit au patient"