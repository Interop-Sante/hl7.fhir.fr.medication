Instance: InLine-Analyse-Presc-SIMVASTATINE
...
* intent = #order
* priority = #routine
* note.text = "Prescription textuelle: SIMVASTATINE 20MG : 1 comprimé par jour​"
* medicationCodeableConcept = $UCD#3400892678979 "SIMVASTATINE EVO 20MG CPR"
