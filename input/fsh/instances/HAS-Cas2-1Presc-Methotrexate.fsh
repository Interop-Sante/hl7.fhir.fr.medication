Instance: HAS-Cas2-1-Presc-Methotrexate
InstanceOf: fr-prescription-bundle-for-example
Usage: #example
* type = #searchset
* entry[0].resource = medication-HAS-Cas2-1-Presc-Methotrexate
* entry[+].resource = medicationrequest-HAS-Cas2-1-Presc-Methotrexate

Instance: medication-HAS-Cas2-1-Presc-Methotrexate
InstanceOf: fr-medication-noncompound
Usage: #inline
* id = "medication-HAS-Cas2-1-Presc-Methotrexate"
...
Instance: medicationrequest-HAS-Cas2-1-Presc-Methotrexate
...
* medicationReference.reference = "#medication-HAS-Cas2-1-Presc-Methotrexate"
* subject.reference = "Patient/14602"
* authoredOn = "2025-06-04T14:47:12Z"
* requester.reference = "Practitioner/smart-Practitioner-71482713"
* groupIdentifier.value = "Presc-HAS-2-1"
