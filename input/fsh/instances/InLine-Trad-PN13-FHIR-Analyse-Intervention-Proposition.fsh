Instance: InLine-Trad-PN13-FHIR-Analyse-Intervention-Proposition
...
* extension[renderedDosageInstruction].valueMarkdown = "1000 mg toutes les 12 heures pendant 2 jours, 2000 mg max/j"
* identifier[0].value = "31638"
* identifier[=].system = "https://somehospital.fr/PrescrptionLine-ID"
* status = #active
* intent = #proposal
* priority = #routine
* note[0].text = "Prescription textuelle: PARACETAMOL (Voie orale) : 1000 mg toutes les 12 heures pendant 2 jours, 2000 mg max/j"
...
* supportingInformation[+].reference = "Task/Analyse-Intervention-Proposition-Trad-PN13-FHIR"
...
* dosageInstruction[=].maxDosePerPeriod.numerator.value = 2000.0
