Instance: HAS-L5-1-Presc-Methotrexate-MV
InstanceOf: fr-prescription-bundle-for-example
Usage: #example
* type = #searchset
* entry[0].resource = medicationrequest-HAS-L5-1-Presc-Methotrexate-MV

Instance: medicationrequest-HAS-L5-1-Presc-Methotrexate-MV
...
* groupIdentifier.value = "Presc-HAS-L5-1-MV"
