Instance: Analyse-Intervention-Proposition-Trad-PN13-FHIR
...
* output[=].valueString = "Suggestion pour prendre en compte la faiblesse hépatique du patient"
* output[+].type.text = "proposition"
* output[=].valueReference.reference = "MedicationRequest/InLine-Trad-PN13-FHIR-Analyse-Intervention-Proposition"