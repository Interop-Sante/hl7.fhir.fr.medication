Instance: HAS-06-1-Presc-Methotrexate
InstanceOf: fr-prescription-bundle-for-example
Usage: #example
Description: "METHOTREXATE  10 mg comprimé (sécable) : 2 comprimés, 1 fois par semaine, le mardi"
* type = #searchset
* entry.resource = medicationrequest-HAS-6-1-Presc-Methotrexate

Instance: medicationrequest-HAS-6-1-Presc-Methotrexate
InstanceOf: fr-medicationrequest
Usage: #inline
* meta.profile = Canonical(fr-medicationrequest)
* extension[renderedDosageInstruction].valueMarkdown = "2 comprimés, 1 fois par semaine, le mardi"
* status = #active
* intent = #order
* priority = #routine
* note.text = "Prescription textuelle: METHOTREXATE  10 mg comprimé (sécable) : 2 comprimés, 1 fois par semaine, le mardi"
