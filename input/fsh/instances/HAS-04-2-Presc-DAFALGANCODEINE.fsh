...
* note[0].text = "Prescription textuelle: DAFALGAN CODEINE®, comprimé : un à deux comprimés toutes les 12 h pendant 10 jours, avec un maximum à 2 comprimés par prise et de 4 comprimés par jour . STOP SI NAUSEES."
* note[=].extension[noteScope].valueCode = #LIPRESCTXT
* dosageInstruction.patientInstruction = "STOP SI NAUSEE"
