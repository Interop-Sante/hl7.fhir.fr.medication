Instance: HAS-L7-Presc-Paracetamol-MV
InstanceOf: fr-prescription-bundle-for-example
Usage: #example
* type = #searchset
* entry[0].resource = medicationrequest-HAS-L7-Presc-Paracetamol-MV

Instance: medicationrequest-HAS-L7-Presc-Paracetamol-MV
...
* groupIdentifier.value = "Presc-HAS-L7-MV"
