...
Usage: #example
* type = #searchset
* entry[0].resource = medication-HAS-18-Presc-BudesonideComp-MV
* entry[+].resource = medication-HAS-18-Presc-Budesonide-MV
* entry[+].resource = medicationrequest-HAS-18-Presc-Budesonide-MV

Instance: medication-HAS-18-Presc-Budesonide-MV
InstanceOf: fr-medication-noncompound
Usage: #inline
* id = "medication-HAS-18-Presc-Budesonide-MV"
...
Instance: medication-HAS-18-Presc-BudesonideComp-MV
InstanceOf: fr-medication-compound
Usage: #inline
* id = "medication-HAS-18-Presc-BudesonideComp-MV"
...
* ingredient[+].itemReference.reference = "#medication-HAS-18-Presc-Budesonide-MV"
