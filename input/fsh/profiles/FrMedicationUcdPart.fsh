...
* manufacturer ..0
* manufacturer ^short = "No distinct manufacturer for each part of the medication. Each part inherits the whole medication manufacturer."
...
* ingredient.item[x] only FrMPSubstanceActive or Reference(FrMedicationUcdPart)
