# HAS-29-Presc-LOVENOX - Guide d'implémentation du médicament v0.1.0
...
> **dosageInstruction****additionalInstruction**:jusqu’à ce que l’INR de l'AVK soit dans la zone thérapeutique cible.**timing**: Once per 1 day**route**:Voie sous-cutanée
