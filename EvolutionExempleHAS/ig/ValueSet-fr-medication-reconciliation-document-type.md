...
| Draft as of 2025-10-23 | *Computable Name*:FRMedicationReconciliationDocumentType |
...
* Include codes provenant de[`https://hl7.fr/ig/fhir/medication/CodeSystem/fr-document-type`](CodeSystem-fr-document-type.md)version 📦0.1.0 où isMedicationReconciliation = true
...
```json
{
  ...
  "url" : "https://hl7.fr/ig/fhir/medication/ValueSet/fr-medication-reconciliation-document-type",
  "version" : "0.1.0",
