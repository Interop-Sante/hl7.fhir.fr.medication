...
| :--- | :--- |
| - | **Rate[x]** |
| * | 5 mg(Details: UCUM codemg = 'mg')/1 h(Details: UCUM codeh = 'h') |


> **dosageInstruction****timing**: Once per 2 hours**route**:Voie intraveineuse
