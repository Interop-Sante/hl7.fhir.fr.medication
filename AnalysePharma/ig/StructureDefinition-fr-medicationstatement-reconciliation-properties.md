...
| Draft as of 2026-05-12 | *Computable Name*:FRMedicationStatementReconciliationProperties |
...
* Utilise ce/t/te Extension: [FR Medication Reconciliation MedicationStatement](StructureDefinition-fr-medication-reconciliation-statement.md)

Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.fr.medication|current/StructureDefinition/fr-medicationstatement-reconciliation-properties)
