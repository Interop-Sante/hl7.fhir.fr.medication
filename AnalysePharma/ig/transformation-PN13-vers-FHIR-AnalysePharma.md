...
* une ressource **Task** suivant le profil [FrInpatientPharmaceuticalAnalysisResultProfile](StructureDefinition-fr-inpatient-pharmaceutical-analysis-result.md)
...
* Créer une ressource **Task** suivant le profil [FrInpatientPharmaceuticalAnalysisResultProfile](StructureDefinition-fr-inpatient-pharmaceutical-analysis-result.md) en utilisant la ressource **ConceptMap** [PN13-FHIR-analpharm-conceptmap]
