# Conversion PN13 vers FHIR pour le résultat d'une analyse pharmaceutique de type intervention pharmaceutique sans proposition - Guide d'implémentation du médicament v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Conversion PN13 vers FHIR pour le résultat d'une analyse pharmaceutique de type intervention pharmaceutique sans proposition**

## ConceptMap: Conversion PN13 vers FHIR pour le résultat d'une analyse pharmaceutique de type intervention pharmaceutique sans proposition 

| | |
| :--- | :--- |
| *Official URL*:https://hl7.fr/ig/fhir/medication/ConceptMap/PN13-FHIR-analpharm-interv-sans-prop-conceptmap | *Version*:0.1.0 |
| Draft as of 2026-05-18 | *Computable Name*:FrPN13FHIRPharmaceuticalAnalysisInterventionSansPropositionConceptMap |

 
ConceptMap pour la conversion PN13 vers FHIR d’un résultat d’une analyse pharmaceutique de type intervention pharmaceutique sans proposition 
...
```json
{
  ...
  "id" : "PN13-FHIR-analpharm-interv-sans-prop-conceptmap",
  "url" : "https://hl7.fr/ig/fhir/medication/ConceptMap/PN13-FHIR-analpharm-interv-sans-prop-conceptmap",
  "version" : "0.1.0",
  "name" : "FrPN13FHIRPharmaceuticalAnalysisInterventionSansPropositionConceptMap",
  "title" : "Conversion PN13 vers FHIR pour le résultat d'une analyse pharmaceutique de type intervention pharmaceutique sans proposition",
  "status" : "draft",
  ...
  },
  {
    "element" : [{
      ...
      "target" : [{
        ...
        "equivalence" : "relatedto",
        "comment" : "Permet de retrouver la ressource MedicationRequest analysée via MedicationRequest.identifier.value",
        "product" : [{
