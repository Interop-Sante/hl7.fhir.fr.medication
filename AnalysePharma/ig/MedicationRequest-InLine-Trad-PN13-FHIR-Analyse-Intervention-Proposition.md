# InLine-Trad-PN13-FHIR-Analyse-Intervention-Proposition - Guide d'implémentation du médicament v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **InLine-Trad-PN13-FHIR-Analyse-Intervention-Proposition**

## Example MedicationRequest: InLine-Trad-PN13-FHIR-Analyse-Intervention-Proposition
...
1000 mg toutes les 12 heures pendant 2 jours, 2000 mg max/j

**identifier**: `https://somehospital.fr/PrescrptionLine-ID`/31638
...
* [Task : groupIdentifier = 10723; status = completed; intent = proposal; authoredOn = 2022-04-11 17:30:53+0200](Task-Analyse-Intervention-Proposition-Trad-PN13-FHIR.md)
...
Prescription textuelle: PARACETAMOL (Voie orale) : 1000 mg toutes les 12 heures pendant 2 jours, 2000 mg max/j
...
**maxDosePerPeriod**: 2000 mg (Détails : code UCUMmg = 'mg')/1 d (Détails : code UCUMd = 'd')
...
```json
{
  ...
  "id" : "InLine-Trad-PN13-FHIR-Analyse-Intervention-Proposition",
  "meta" : {
  ...
  "extension" : [{
    ...
    "valueMarkdown" : "1000 mg toutes les 12 heures pendant 2 jours, 2000 mg max/j"
  }],
  "identifier" : [{
