# InLine-Analyse-Presc-ESOMEPRAZOLE - Guide d'implémentation du médicament v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **InLine-Analyse-Presc-ESOMEPRAZOLE**

## Example MedicationRequest: InLine-Analyse-Presc-ESOMEPRAZOLE
...
**medication**: ESOMEPRAZOLE EVO 20MG CPR

**subject**: [Patient/14602](Patient/14602)

**authoredOn**: 2026-03-22 16:19:00+0100
...
Prescription textuelle: ESOMEPRAZOLE EVO 20MG : 1 comprimé par jour​
...
```json
{
  ...
  "id" : "InLine-Analyse-Presc-ESOMEPRAZOLE",
  "meta" : {
  ...
  "medicationCodeableConcept" : {
    "coding" : [{
      ...
      "code" : "3400894032311",
      "display" : "ESOMEPRAZOLE EVO 20MG CPR"
    }]
  },
  "subject" : {
  ...
  "note" : [{
    "text" : "Prescription textuelle: ESOMEPRAZOLE EVO 20MG : 1 comprimé par jour​"
  }],
  "dosageInstruction" : [{
    "timing" : {
      "repeat" : {
